...
import { type AccordionGroupChangeEventDetail, type BreadcrumbCollapsedClickEventDetail, type CheckboxChangeEventDetail, type DatetimeChangeEventDetail, type InputChangeEventDetail, type InputInputEventDetail, type IonAccordionGroupCustomEvent, type IonBreadcrumbsCustomEvent, type IonCheckboxCustomEvent, type IonContentCustomEvent, type IonDatetimeCustomEvent, type IonInputCustomEvent, type IonPickerColumnCustomEvent, type IonRadioGroupCustomEvent, type IonRangeCustomEvent, type IonRefresherCustomEvent, type IonReorderGroupCustomEvent, type IonSearchbarCustomEvent, type IonSegmentCustomEvent, type IonSelectCustomEvent, type IonTextareaCustomEvent, type IonToggleCustomEvent, type ItemReorderEventDetail, type PickerColumnChangeEventDetail, type RadioGroupChangeEventDetail, type RangeChangeEventDetail, type RangeKnobMoveEndEventDetail, type RangeKnobMoveStartEventDetail, type RefresherEventDetail, type ScrollBaseDetail, type ScrollDetail, type SearchbarChangeEventDetail, type SearchbarInputEventDetail, type SegmentChangeEventDetail, type SelectChangeEventDetail, type TextareaChangeEventDetail, type TextareaInputEventDetail, type ToggleChangeEventDetail } from "mr-ionic-core";
import { IonAccordionGroup as IonAccordionGroupElement, defineCustomElement as defineIonAccordionGroup } from "mr-ionic-core/components/ion-accordion-group.js";
import { IonAccordion as IonAccordionElement, defineCustomElement as defineIonAccordion } from "mr-ionic-core/components/ion-accordion.js";
import { IonAvatar as IonAvatarElement, defineCustomElement as defineIonAvatar } from "mr-ionic-core/components/ion-avatar.js";
import { IonBackdrop as IonBackdropElement, defineCustomElement as defineIonBackdrop } from "mr-ionic-core/components/ion-backdrop.js";
import { IonBadge as IonBadgeElement, defineCustomElement as defineIonBadge } from "mr-ionic-core/components/ion-badge.js";
import { IonBreadcrumbs as IonBreadcrumbsElement, defineCustomElement as defineIonBreadcrumbs } from "mr-ionic-core/components/ion-breadcrumbs.js";
import { IonButtons as IonButtonsElement, defineCustomElement as defineIonButtons } from "mr-ionic-core/components/ion-buttons.js";
import { IonCardContent as IonCardContentElement, defineCustomElement as defineIonCardContent } from "mr-ionic-core/components/ion-card-content.js";
import { IonCardHeader as IonCardHeaderElement, defineCustomElement as defineIonCardHeader } from "mr-ionic-core/components/ion-card-header.js";
import { IonCardSubtitle as IonCardSubtitleElement, defineCustomElement as defineIonCardSubtitle } from "mr-ionic-core/components/ion-card-subtitle.js";
import { IonCardTitle as IonCardTitleElement, defineCustomElement as defineIonCardTitle } from "mr-ionic-core/components/ion-card-title.js";
import { IonCheckbox as IonCheckboxElement, defineCustomElement as defineIonCheckbox } from "mr-ionic-core/components/ion-checkbox.js";
import { IonChip as IonChipElement, defineCustomElement as defineIonChip } from "mr-ionic-core/components/ion-chip.js";
import { IonCol as IonColElement, defineCustomElement as defineIonCol } from "mr-ionic-core/components/ion-col.js";
import { IonContent as IonContentElement, defineCustomElement as defineIonContent } from "mr-ionic-core/components/ion-content.js";
import { IonDatetimeButton as IonDatetimeButtonElement, defineCustomElement as defineIonDatetimeButton } from "mr-ionic-core/components/ion-datetime-button.js";
import { IonDatetime as IonDatetimeElement, defineCustomElement as defineIonDatetime } from "mr-ionic-core/components/ion-datetime.js";
import { IonFabList as IonFabListElement, defineCustomElement as defineIonFabList } from "mr-ionic-core/components/ion-fab-list.js";
import { IonFab as IonFabElement, defineCustomElement as defineIonFab } from "mr-ionic-core/components/ion-fab.js";
import { IonFooter as IonFooterElement, defineCustomElement as defineIonFooter } from "mr-ionic-core/components/ion-footer.js";
import { IonGrid as IonGridElement, defineCustomElement as defineIonGrid } from "mr-ionic-core/components/ion-grid.js";
import { IonHeader as IonHeaderElement, defineCustomElement as defineIonHeader } from "mr-ionic-core/components/ion-header.js";
import { IonImg as IonImgElement, defineCustomElement as defineIonImg } from "mr-ionic-core/components/ion-img.js";
import { IonInfiniteScrollContent as IonInfiniteScrollContentElement, defineCustomElement as defineIonInfiniteScrollContent } from "mr-ionic-core/components/ion-infinite-scroll-content.js";
import { IonInfiniteScroll as IonInfiniteScrollElement, defineCustomElement as defineIonInfiniteScroll } from "mr-ionic-core/components/ion-infinite-scroll.js";
import { IonInputPasswordToggle as IonInputPasswordToggleElement, defineCustomElement as defineIonInputPasswordToggle } from "mr-ionic-core/components/ion-input-password-toggle.js";
import { IonInput as IonInputElement, defineCustomElement as defineIonInput } from "mr-ionic-core/components/ion-input.js";
import { IonItemDivider as IonItemDividerElement, defineCustomElement as defineIonItemDivider } from "mr-ionic-core/components/ion-item-divider.js";
import { IonItemGroup as IonItemGroupElement, defineCustomElement as defineIonItemGroup } from "mr-ionic-core/components/ion-item-group.js";
import { IonItemOptions as IonItemOptionsElement, defineCustomElement as defineIonItemOptions } from "mr-ionic-core/components/ion-item-options.js";
import { IonItemSliding as IonItemSlidingElement, defineCustomElement as defineIonItemSliding } from "mr-ionic-core/components/ion-item-sliding.js";
import { IonLabel as IonLabelElement, defineCustomElement as defineIonLabel } from "mr-ionic-core/components/ion-label.js";
import { IonListHeader as IonListHeaderElement, defineCustomElement as defineIonListHeader } from "mr-ionic-core/components/ion-list-header.js";
import { IonList as IonListElement, defineCustomElement as defineIonList } from "mr-ionic-core/components/ion-list.js";
import { IonMenuButton as IonMenuButtonElement, defineCustomElement as defineIonMenuButton } from "mr-ionic-core/components/ion-menu-button.js";
import { IonMenuToggle as IonMenuToggleElement, defineCustomElement as defineIonMenuToggle } from "mr-ionic-core/components/ion-menu-toggle.js";
import { IonMenu as IonMenuElement, defineCustomElement as defineIonMenu } from "mr-ionic-core/components/ion-menu.js";
import { IonNavLink as IonNavLinkElement, defineCustomElement as defineIonNavLink } from "mr-ionic-core/components/ion-nav-link.js";
import { IonNav as IonNavElement, defineCustomElement as defineIonNav } from "mr-ionic-core/components/ion-nav.js";
import { IonNote as IonNoteElement, defineCustomElement as defineIonNote } from "mr-ionic-core/components/ion-note.js";
import { IonPickerColumnOption as IonPickerColumnOptionElement, defineCustomElement as defineIonPickerColumnOption } from "mr-ionic-core/components/ion-picker-column-option.js";
import { IonPickerColumn as IonPickerColumnElement, defineCustomElement as defineIonPickerColumn } from "mr-ionic-core/components/ion-picker-column.js";
import { IonPicker as IonPickerElement, defineCustomElement as defineIonPicker } from "mr-ionic-core/components/ion-picker.js";
import { IonProgressBar as IonProgressBarElement, defineCustomElement as defineIonProgressBar } from "mr-ionic-core/components/ion-progress-bar.js";
import { IonRadioGroup as IonRadioGroupElement, defineCustomElement as defineIonRadioGroup } from "mr-ionic-core/components/ion-radio-group.js";
import { IonRadio as IonRadioElement, defineCustomElement as defineIonRadio } from "mr-ionic-core/components/ion-radio.js";
import { IonRange as IonRangeElement, defineCustomElement as defineIonRange } from "mr-ionic-core/components/ion-range.js";
import { IonRefresherContent as IonRefresherContentElement, defineCustomElement as defineIonRefresherContent } from "mr-ionic-core/components/ion-refresher-content.js";
import { IonRefresher as IonRefresherElement, defineCustomElement as defineIonRefresher } from "mr-ionic-core/components/ion-refresher.js";
import { IonReorderGroup as IonReorderGroupElement, defineCustomElement as defineIonReorderGroup } from "mr-ionic-core/components/ion-reorder-group.js";
import { IonReorder as IonReorderElement, defineCustomElement as defineIonReorder } from "mr-ionic-core/components/ion-reorder.js";
import { IonRippleEffect as IonRippleEffectElement, defineCustomElement as defineIonRippleEffect } from "mr-ionic-core/components/ion-ripple-effect.js";
import { IonRow as IonRowElement, defineCustomElement as defineIonRow } from "mr-ionic-core/components/ion-row.js";
import { IonSearchbar as IonSearchbarElement, defineCustomElement as defineIonSearchbar } from "mr-ionic-core/components/ion-searchbar.js";
import { IonSegmentButton as IonSegmentButtonElement, defineCustomElement as defineIonSegmentButton } from "mr-ionic-core/components/ion-segment-button.js";
import { IonSegment as IonSegmentElement, defineCustomElement as defineIonSegment } from "mr-ionic-core/components/ion-segment.js";
import { IonSelectOption as IonSelectOptionElement, defineCustomElement as defineIonSelectOption } from "mr-ionic-core/components/ion-select-option.js";
import { IonSelect as IonSelectElement, defineCustomElement as defineIonSelect } from "mr-ionic-core/components/ion-select.js";
import { IonSkeletonText as IonSkeletonTextElement, defineCustomElement as defineIonSkeletonText } from "mr-ionic-core/components/ion-skeleton-text.js";
import { IonSpinner as IonSpinnerElement, defineCustomElement as defineIonSpinner } from "mr-ionic-core/components/ion-spinner.js";
import { IonSplitPane as IonSplitPaneElement, defineCustomElement as defineIonSplitPane } from "mr-ionic-core/components/ion-split-pane.js";
import { IonTab as IonTabElement, defineCustomElement as defineIonTab } from "mr-ionic-core/components/ion-tab.js";
import { IonText as IonTextElement, defineCustomElement as defineIonText } from "mr-ionic-core/components/ion-text.js";
import { IonTextarea as IonTextareaElement, defineCustomElement as defineIonTextarea } from "mr-ionic-core/components/ion-textarea.js";
import { IonThumbnail as IonThumbnailElement, defineCustomElement as defineIonThumbnail } from "mr-ionic-core/components/ion-thumbnail.js";
import { IonTitle as IonTitleElement, defineCustomElement as defineIonTitle } from "mr-ionic-core/components/ion-title.js";
import { IonToggle as IonToggleElement, defineCustomElement as defineIonToggle } from "mr-ionic-core/components/ion-toggle.js";
import { IonToolbar as IonToolbarElement, defineCustomElement as defineIonToolbar } from "mr-ionic-core/components/ion-toolbar.js";
